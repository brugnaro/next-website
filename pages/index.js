          ...
          <div className="row justify-content-center m-45px-b md-m-25px-b">
            <div className="col-md-10 col-lg-8 col-xl-7">
              <div className="section-title">
                ...
                <p>TheChecker is the <strong>#1 email verification software</strong> based on independent reviews.</p>
              </div>
            </div>
          </div>
          <div className="row">
            <div className="col-12 col-md-6 col-lg-4 m-15px-tb">
              <div className="feature-box-01">
                ...
                <h4><a href="#"><stong>4.7</stong>/5</a></h4>
            ...
            <div className="col-12 col-md-6 col-lg-4 m-15px-tb">
              <div className="feature-box-01">
                ...
                <h4><a href="#"><stong>4.9</stong>/5</a></h4>
                <p className="large"><span>✮✮✮✮✮ </span></p>
              </div>
            </div>
            <div className="col-12 col-md-6 col-lg-4 m-15px-tb">
              <div className="feature-box-01">
                ...
                <h4><a href="#"><stong>4.6</stong>/5</a></h4>
                <p className="large"><span>✮✮✮✮✮ </span></p>
              </div>
            </div>
          </div>

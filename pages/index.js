            ...
            <div className="row align-items-center">
              <div className="col-md-6">
                <div className="feature-box-02 title">
                  ...
                  <h2 className="m-20px-b font-alt">Get rid of the bad emails before they enter your list</h2>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-md-6">
                <div className="feature-box-02 title">
                  ...
                  <h2>Connect with your favorite email marketing tool</h2>
            ...
            <div className="row align-items-center">
              <div className="col-md-6">
                <div className="feature-box-02 title">
                  ...
                  <h2 className="m-20px-b font-alt">Easily clean your current email lists and databases</h2>
          ...
          <div className="container">
            <div className="row align-items-center">
              ...
              <div className="col-md-6">
                <div className="feature-box-02 title">
                  <label className="theme2nd-color">Seamless integrations</label>
                  <h2 className="m-20px-b font-alt">Add an email validation tool to any website or app</h2>
